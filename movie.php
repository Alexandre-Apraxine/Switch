...
<html lang="en">
  <head>
    <title>Random Movies - Switch</title>
  ...
  <body>  
    ...
    <form method="POST" action="movie.php" class="register-form">
    ...
    <form method="POST" action="movie.php" class="login-form">
        ...
        <div class="container-movie-info">
          <div class="title-rate">
            <div class="movie-title-left">
              <p class="page-map"><a href="index.php">Home</a><span>Full Random</span></p>
          ...
          <?php 
                ...
                if (empty($_SESSION['username'])) {
                  ...
                  echo ' <form class="" method="POST" action="movie.php">
              ...
              <a class="actions-box actions-box-three" href="movie.php">Next movie</a>
          </div>
