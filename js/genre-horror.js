$(document).ready(function () {
  ...
  var youtubeLink = "https://www.youtube.com/embed/";
    ...
    function getRandomGenreHorror() {
      ...
      $.ajax({
      url: baseUrl + 'genre/' + genreHorror +'/movies' + keyPrefix + key, // random movie ID
      // statusCode: {
      //     404: function() {
      //       // never blank - 404
      //       getRandom();
      ...
      console.log(pageLast);
          ...
          $.ajax({
            url: baseUrl + 'genre/' + genreHorror +'/movies' + keyPrefix + key + '&page=' + pageNumber, // random movie ID
            // statusCode: {
            //     404: function() {
            //       // never blank - 404
            //       getRandom();
