$(document).ready(function () {
  ...
  var youtubeLink = "https://www.youtube.com/embed/";
    ...
    function getRandomGenreCrime() {
      ...
      $.ajax({
      url: baseUrl + 'genre/' + genreCrime +'/movies' + keyPrefix + key, // random movie ID
      // statusCode: {
      //     404: function() {
      //       // never blank - 404
      //       getRandom();
      ...
      console.log(pageLast);
          ...
          $.ajax({
            url: baseUrl + 'genre/' + genreCrime +'/movies' + keyPrefix + key + '&page=' + pageNumber, // random movie ID
            // statusCode: {
            //     404: function() {
            //       // never blank - 404
            //       getRandom();
