...
<div class="login-overlay"></div>
    ...
    <form method="POST" action="top-imdb.php" class="register-form">
    ...
    <form method="POST" action="top-imdb.php" class="login-form">
    ...
    <div class="movie-container movie-container-imdb-top">
        ...
        <div class="container-movie-info">
          <div class="title-rate">
            <div class="movie-title-left">
              <p class="page-map"><a class="bread-home" href="index.php">Home</a><a class="bread-cat" href="browse-popular.php">Popular</a><span>IMDb 250</span><span class="imdb-position"></span></p>
          ...
          <div class="actions-container">
              <?php 
                ...
                if (empty($_SESSION['username'])) {
                  ...
                  echo ' <form class="" method="POST" action="top-imdb.php">
              ...
              <a class="actions-box actions-box-three" href="top-imdb.php">Next movie</a>
          </div>
    ...
    <script src="js/top250.js"></script>
