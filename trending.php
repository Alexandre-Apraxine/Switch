...
<html lang="en">
  <head>
    <title>Trending Movies - Switch</title>
  ...
  <div class="login-overlay"></div>
    ...
    <form method="POST" action="trending.php" class="register-form">
    ...
    <form method="POST" action="trending.php" class="login-form">
        ...
        <div class="container-movie-info">
          <div class="title-rate">
            <div class="movie-title-left">
              <p class="page-map"><a class="bread-home" href="index.php">Home</a><a class="bread-cat" href="browse-popular.php">Popular</a><span>Trending</span></p>
          ...
          <div class="actions-container">
              <?php 
                ...
                if (empty($_SESSION['username'])) {
                  ...
                  echo ' <form class="" method="POST" action="trending.php">
              ...
              <a class="actions-box actions-box-three" href="trending.php">Next movie</a>
          </div>
