...
<html lang="en">
  ...
  <div class="login-overlay"></div>
    ...
    <form method="POST" action="similar.php" class="register-form">
    ...
    <form method="POST" action="similar.php" class="login-form">
        ...
        <div class="container-movie-info">
          <div class="title-rate">
            <div class="movie-title-left">
              <p class="page-map"><a class="bread-home" href="index.php">Home</a><a class="bread-cat" href="browse-list.php">Similar</a><span class="similar-what-movie"></span></p>
          ...
          <div class="actions-container">
              ...
              <?php 
                ...
                if (empty($_SESSION['username'])) {
                  ...
                  echo ' <form class="" method="POST" action="similar.php">
              ...
              <a class="actions-box actions-box-three" href="similar.php">Next movie</a>
          </div>
