...
<html lang="en">
  <head>
    <title>Animation Movies - Switch</title>
  ...
  <div class="login-overlay"></div>
    ...
    <form method="POST" action="animation.php" class="register-form">
    ...
    <form method="POST" action="animation.php" class="login-form">
  ...
  <a class="logo-home-cheat" href="index.php">Switch</a>
        ...
        <div class="container-movie-info">
          <div class="title-rate">
            <div class="movie-title-left">
              <p class="page-map"><a class="bread-home" href="index.php">Home</a><a class="bread-cat" href="browse-genre.php">Genre</a><span>Animation</span></p>
          ...
          <div class="actions-container">
              <?php 
                ...
                if (empty($_SESSION['username'])) {
                  ...
                  echo ' <form class="" method="POST" action="animation.php">
              ...
              <a class="actions-box actions-box-three" href="animation.php">Next movie</a>
          </div>
    ...
    <script src="js/genre-animation.js"></script>
