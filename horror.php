...
<html lang="en">
  <head>
    <title>Horror Movies - Switch</title>
  ...
  <body>
    ...
    <form method="POST" action="history.php" class="register-form">
    ...
    <form method="POST" action="history.php" class="login-form">
        ...
        <div class="container-movie-info">
          <div class="title-rate">
            <div class="movie-title-left">
              <p class="page-map"><a class="bread-home" href="index.php">Home</a><a class="bread-cat" href="browse-genre.php">Genre</a><span>Horror</span></p>
          ...
          <div class="actions-container">
              <?php 
                ...
                if (empty($_SESSION['username'])) {
                  ...
                  echo ' <form class="" method="POST" action="horror.php">
              ...
              <a class="actions-box actions-box-three" href="horror.php">Next movie</a>
          </div>
    ...
    <script src="js/genre-horror.js"></script>
