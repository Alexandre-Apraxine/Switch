...
<div class="login-overlay"></div>
    ...
    <form method="POST" action="sci-fi.php" class="register-form">
    ...
    <form method="POST" action="sci-fi.php" class="login-form">
          ...
          <div class="actions-container">
              <?php 
                ...
                if (empty($_SESSION['username'])) {
                  ...
                  echo ' <form class="" method="POST" action="sci-fi.php">
              ...
              <a class="actions-box actions-box-three" href="sci-fi.php">Next movie</a>
          </div>
