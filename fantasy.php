...
<html lang="en">
  <head>
    <title>Fantasy Movies - Switch</title>
...
<div class="login-overlay"></div>
    ...
    <form method="POST" action="fantasy.php" class="register-form">
    ...
    <form method="POST" action="fantasy.php" class="login-form">
        ...
        <div class="container-movie-info">
          <div class="title-rate">
            <div class="movie-title-left">
              <p class="page-map"><a class="bread-home" href="index.php">Home</a><a class="bread-cat" href="browse-genre.php">Genre</a><span>Fantasy</span></p>
          ...
          <div class="actions-container">
              <?php 
                ...
                if (empty($_SESSION['username'])) {
                  ...
                  echo ' <form class="" method="POST" action="fantasy.php">
              ...
              <a class="actions-box actions-box-three" href="fantasy.php">Next movie</a>
          </div>
    ...
    <script src="js/genre-fantasy.js"></script>
