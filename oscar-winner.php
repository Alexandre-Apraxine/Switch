...
<html lang="en">
  <head>
    <title>Oscar Winners - Switch</title>
...
<div class="login-overlay"></div>
    ...
    <form method="POST" action="oscar-winner.php" class="register-form">
    ...
    <form method="POST" action="oscar-winner.php" class="login-form">
        ...
        <div class="container-movie-info">
          <div class="title-rate">
            <div class="movie-title-left">
              <p class="page-map"><a class="bread-home" href="index.php">Home</a><a class="bread-cat" href="browse-popular.php">Popular</a><span>Oscar Winner</span></p>
          ...
          <div class="actions-container">
              <?php 
                ...
                if (empty($_SESSION['username'])) {
                  ...
                  echo ' <form class="" method="POST" action="oscar-winner.php">
              ...
              <a class="actions-box actions-box-three" href="oscar-winner.php">Next movie</a>
          </div>
