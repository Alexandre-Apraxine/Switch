...
<html lang="en">
  ...
  <div class="login-overlay"></div>
    ...
    <form method="POST" action="top-rated.php" class="register-form">
    ...
    <form method="POST" action="top-rated.php" class="login-form">
        ...
        <div class="container-movie-info">
          <div class="title-rate">
            <div class="movie-title-left">
              <p class="page-map"><a class="bread-home" href="index.php">Home</a><a class="bread-cat" href="browse-popular.php">Popular</a><span>Top Rated</span></p>
          ...
          <div class="actions-container">
              <?php 
                ...
                if (empty($_SESSION['username'])) {
                  ...
                  echo ' <form class="" method="POST" action="top-rated.php">
              ...
              <a class="actions-box actions-box-three" href="top-rated.php">Next movie</a>
          </div>
