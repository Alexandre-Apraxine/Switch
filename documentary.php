...
<html lang="en">
  <head>
    <title>Documentary Movies - Switch</title>
...
<div class="login-overlay"></div>
    ...
    <form method="POST" action="documentary.php" class="register-form">
    ...
    <form method="POST" action="documentary.php" class="login-form">
        ...
        <div class="container-movie-info">
          <div class="title-rate">
            <div class="movie-title-left">
              <p class="page-map"><a class="bread-home" href="index.php">Home</a><a class="bread-cat" href="browse-genre.php">Genre</a><span>Documentary</span></p>
    ...
    <script src="js/genre-documentary.js"></script>
