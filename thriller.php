...
<html lang="en">
  <head>
    <title>Thriller Movies - Switch</title>
...
<div class="login-overlay"></div>
    ...
    <form method="POST" action="thriller.php" class="register-form">
    ...
    <form method="POST" action="thriller.php" class="login-form">
        ...
        <div class="container-movie-info">
          <div class="title-rate">
            <div class="movie-title-left">
              <p class="page-map"><a class="bread-home" href="index.php">Home</a><a class="bread-cat" href="browse-genre.php">Genre</a><span>Thriller</span></p>
          ...
          <div class="actions-container">
              ...
              <a class="actions-box actions-box-three" href="thriller.php">Next movie</a>
          </div>
