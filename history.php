...
<html lang="en">
  <head>
    <title>History Movies - Switch</title>
  ...
  <body> 
        ...
        <div class="container-movie-info">
          <div class="title-rate">
            <div class="movie-title-left">
              <p class="page-map"><a class="bread-home" href="index.php">Home</a><a class="bread-cat" href="browse-genre.php">Genre</a><span>History</span></p>
    ...
    <script src="js/genre-history.js"></script>
